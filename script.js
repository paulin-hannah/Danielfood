...
var foods = document.getElementById("foods")
  ...
  var liinuput1 = checkbox("input","type","checkbox","name","food","id","input-LETTUCE","value","LETTUCE")
  var liinuput2 = checkbox("input","type","checkbox","name","food","id","input-AVACADO","value","AVACADO")
  var liinuput3 = checkbox("input","type","checkbox","name","food","id","input-Broccoli","value","Broccoli")
  var liinuput4 = checkbox("input","type","checkbox","name","food","id","input-Fig","value","Fig")
  var liinuput5 = checkbox("input","type","checkbox","name","food","id","input-Dates","value","LETTUCE","Dates")
  ...
  var LETTUCE = t("label","for","inner-LETTUCE","LETTUCE" )
  var AVACADO = t("label","for","inner-AVACADO","AVACADO")
 var Broccoli = t("label","for","inner-Broccoli","Broccoli" )
 var Fig = t("label","for","inner-Fig","Fig" )
 var Dates= t("label","for","inner-Dates","Dates" )
 
foods.append(fooditems)
foods.append(ul)
ul.append(li1,li2,li3,li4,li5)
li1.append(liinuput1,LETTUCE)
li2.append(liinuput2,AVACADO)
li3.append(liinuput3,Broccoli)
li4.append(liinuput4,Fig)
li5.append(liinuput5,Dates)
...
reset()
    ...
    alert(`Please select only 2 food item & fill all the values `)
}
})
